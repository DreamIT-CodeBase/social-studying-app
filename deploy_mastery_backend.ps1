# Deploy Latest Mastery & Question Format Backend to Azure Container Apps
$ErrorActionPreference = "Stop"

$img = "acrssadevxumnzboir5vz2.azurecr.io/social-study-api:20260921-mastery-v1"
$rg = "rg-ssa2-dev"
...
Write-Host "Backend deployment to Azure Container Apps completed successfully!"
