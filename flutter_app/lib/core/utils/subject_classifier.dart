...
const List<String> _physicsTerms = [
  'quantum mechanics', 'thermodynamics', 'nuclear physics', 'magnetic field',
  'electric current',
  // English
  ...
  // Hindi
  'भौतिक विज्ञान', 'भौतिकी', 'भौतिक', 'गति के नियम', 'गुरुत्वाकर्षण', 'ऊर्जा',
  'प्रकाश',
  // Spanish
  'física clásica', 'física', 'fisica', 'fuerza', 'gravedad', 'movimiento',
  'onda',
  'energía', 'energia', 'velocidad', 'mecánica', 'mecanica', 'electricidad',
  // French
  'physique quantique', 'physique', 'gravité', 'gravite', 'mouvement',
  'vitesse',
  // German
...
const List<String> _chemistryTerms = [
  ...
  'ap chemistry', 'ap chem', 'general chemistry', 'gen chem', 'organic chem',
  'orgo',
  ...
  'रासायनिक अभिक्रियाएं', 'रासायनिक अभिक्रिया', 'रासायनिक समीकरण',
  'आवर्त सारणी',
  'química inorgánica', 'quimica inorganica', 'química orgánica',
  'chimie organique',
  // English
  ...
  // Hindi
  'रसायन विज्ञान', 'रसायनशास्त्र', 'रसायनिक', 'रसायन', 'परमाणु', 'अणु',
  'रासायनिक',
  // Spanish
  ...
  // German
  'chemie', 'chemisch', 'bindung', 'molekül', 'molekuel', 'reaktion',
  'verbindung',
];
...
const List<String> _mathTerms = [
  ...
  'cálculo', 'calculo', 'ecuación', 'ecuacion', 'trigonometría',
  'trigonometria',
  // French
  'mathématiques', 'mathematiques', 'algèbre', 'algebre', 'géométrie',
  'geometrie',
  'calcul', 'équation', 'equation', 'trigonométrie', 'trigonometrie',
  // German
  'mathematik', 'mathe', 'geometrie', 'gleichung',
