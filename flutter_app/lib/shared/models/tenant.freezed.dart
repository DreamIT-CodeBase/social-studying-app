...
mixin _$Tenant {
  ...
  TenantType get type => throw _privateConstructorUsedError;
...
class _$TenantImpl implements _Tenant {
  ...
  @override
  String toString() {
    return 'Tenant(id: $id, name: $name, type: $type, adminUserId: $adminUserId, createdAt: $createdAt, isDeleted: $isDeleted)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, type, adminUserId, createdAt, isDeleted);
...
abstract class _Tenant implements Tenant {
  const factory _Tenant(
      ...
      required final TenantType type,
      required final String adminUserId,
      required final DateTime createdAt,
      final bool isDeleted}) = _$TenantImpl;
